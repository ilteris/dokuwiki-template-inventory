...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $conf['lang']; ?>" lang="<?php echo $conf['lang']; ?>">
    <head>
        ...
        <title><?php echo hsc($conf['title'])?></title>
    </head>
    <body>
	
        <div id="header"><?php tpl_link(wl(),'<img src="'.DOKU_TPL.'images/banner.png" alt="'.hsc($conf['title']).'"/>','name="dokuwiki__top" id="dokuwiki__top" accesskey="h" title="[ALT+H]"')?>
        ...
        <div id="doc"><?php print "This page last modified on " . dformat($INFO['lastmod']) . ".";?></div>
        <div id="footer">
            <?php tpl_searchform()?>
            <ul>
